...
.code
		call InitCPUTimer ; xmm1 and xmm2 argument but not supported by invoke so assume its passed 
		IF TEST_OPCODES eq 0
			IFDEF rax
				mov reg_pc, rcx
			ELSE
				mov reg_pc, mem
...
Z80Loop:
       ...
       OpEDB0:
			  ...
			  ; invoke RunOpcodeTimer, is in Inst_LDIR -> BC != 0 ? 21 5 : 16 4	
			  jmp Z80Loop
       OpEDB1:
			  ;EDB1		CPIR
			  invoke Inst_CPIR, memPtr
			  ; invoke RunOpcodeTimer, is in Inst_CPIR -> BC != 0 ? 21 5 : 16 4	
			  jmp Z80Loop
       OpEDB2:
			  ;EDB2		INIR	21/16 	4/3
       ...
       OpEDB8:
			  ...
			  ; invoke RunOpcodeTimer, is in Inst_LDDR -> BC != 0 ? 21 5 : 16 4
			  jmp Z80Loop
       OpEDB9:
			  ;EDB9		CPDR
